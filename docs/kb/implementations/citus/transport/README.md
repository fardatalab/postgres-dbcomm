...
- [dpu_collector_admission_starvation_mixed_workload.md](dpu_collector_admission_starvation_mixed_workload.md) - The mixed pgbench+basebackup hang, now RESOLVED (citus 6392a1853) by a control-mailbox class-admission fix — with an honest causation caveat (the census refuted the specific hypothesis). Records seven refuted causes and three defects fixed along the way.
