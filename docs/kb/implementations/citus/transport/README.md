...
- [dpu_collector_admission_starvation_mixed_workload.md](dpu_collector_admission_starvation_mixed_workload.md) - The mixed pgbench+basebackup hang: investigation record and current frontier (a P3 result stream whose peer binding never activates), plus four refuted causes and two defects fixed along the way.
