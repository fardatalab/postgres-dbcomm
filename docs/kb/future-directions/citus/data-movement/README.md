...
<!-- kb-docs:start -->
- [command_dispatch_completion_plane.md](command_dispatch_completion_plane.md) - Future design for replacing the temporary worker SQL/libpq start-wait seam with a typed command dispatch/completion plane under the shared RDMA transport substrate.
