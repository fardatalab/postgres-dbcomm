# Citus Future Directions

## Purpose

Index forward-looking Citus design notes. Canonical grounded behavior should stay under `docs/kb/citus/`; this tree should cross-link back to those factual notes.
