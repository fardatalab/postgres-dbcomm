 ...
 * DOCA Buffer is a thread-unsafe object.
 *
 * @{
 */
 ...
 *
 * @details When refcount 0 reached, all related resources should be released. For example if the element points into
 ...
 */
DOCA_EXPERIMENTAL
doca_error_t doca_buf_chain_list_tail(struct doca_buf *list1_head, struct doca_buf *list1_tail, struct doca_buf *list2);
