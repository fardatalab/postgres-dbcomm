...
enum doca_task_submit_flag {
	...
	DOCA_TASK_SUBMIT_FLAG_OPTIMIZE_REPORTS = (1U << 1),	     /**
								      ...
								      */
	DOCA_TASK_SUBMIT_FLAG_RANGE_PROFILING_REQUESTED = (1U << 2), /**
								      * Use flag to inform doca_ctx that this task
								      * requires range profiling if possible.
								      */
	DOCA_TASK_SUBMIT_FLAG_RANGE_PROFILING_PROCESSED = (1U << 3), /**
								      * Use flag to inform doca_ctx that this task has
								      * been processed by range profiling.
								      */
};
